...
public class AddCoIdentityDetailBean implements Serializable {
	...
	private List<IdentityType> lstIdentityList = new ArrayList<IdentityType>();
	...
	public List<IdentityType> getLstIdentityList() {
		return lstIdentityList;
	}

	public void setLstIdentityList(List<IdentityType> lstIdentityList) {
		this.lstIdentityList = lstIdentityList;
	}
