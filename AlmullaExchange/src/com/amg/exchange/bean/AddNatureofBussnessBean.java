...
public class AddNatureofBussnessBean implements Serializable {
	...
	private List<RuleBusinessNature> lstBussineesNature = new ArrayList<RuleBusinessNature>();
	...
	public List<RuleBusinessNature> getLstBussineesNature() {
		return lstBussineesNature;
	}

	public void setLstBussineesNature(List<RuleBusinessNature> lstBussineesNature) {
		this.lstBussineesNature = lstBussineesNature;
	}
