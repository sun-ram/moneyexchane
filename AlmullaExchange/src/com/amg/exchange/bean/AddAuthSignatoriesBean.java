...
private String name;
	...
	private List<IdentityType> lstaAuthourizedIdentityList = new ArrayList<IdentityType>();
	...
	public List<IdentityType> getLstaAuthourizedIdentityList() {
		return lstaAuthourizedIdentityList;
	}

	public void setLstaAuthourizedIdentityList(
			List<IdentityType> lstaAuthourizedIdentityList) {
		this.lstaAuthourizedIdentityList = lstaAuthourizedIdentityList;
	}
