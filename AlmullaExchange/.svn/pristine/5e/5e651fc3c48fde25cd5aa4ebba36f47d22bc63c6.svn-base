...
public class AddBankDDPrintLocBean implements Serializable {
	...
	//TODO
	public AddBankDDPrintLocBean(String countryName, String dDAgent,String dDPrintLocation,BigDecimal countryId,BigDecimal stateId,BigDecimal districtId,BigDecimal  cityId,BigDecimal bankBranchId ) {
